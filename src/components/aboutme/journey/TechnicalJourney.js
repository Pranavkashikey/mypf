    ...
    <div className="mt-5">
      ...
      <VerticalTimeline>
        ...
        >
          ...
          icon={<DiReact />}
        >
          <h3 className="vertical-timeline-element-title">TailwindCSS</h3>
        </VerticalTimelineElement>
          ...
          icon={<DiReact />}
        >
          <h3 className="vertical-timeline-element-title">SOCKETIO</h3>
        </VerticalTimelineElement>
          ...
          icon={<DiReact />}
        >
          <h3 className="vertical-timeline-element-title">JWT</h3>
        </VerticalTimelineElement>
          ...
          icon={<DiReact />}
        >
          <h3 className="vertical-timeline-element-title">BcryptJS</h3>
        </VerticalTimelineElement>
          ...
          icon={<DiReact />}
        >
          <h3 className="vertical-timeline-element-title">Multer</h3>
        </VerticalTimelineElement>
